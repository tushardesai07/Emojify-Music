...
public class MusicList extends AppCompatActivity {
    ...
    private void initviews() {
        ...
        textv.setText(mood + " Mood Playlist");//firebase
        if(mood.equals("Fear") || mood.equals("Disgust") || mood.equals("Surprise") ||mood.equals("Angry"))
        {
            mood = "Sad";
        }
        //Firebase connection
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item)
    {
        switch (item.getItemId()){
            case R.id.item1:
                //All
                Toast.makeText(this, "Fetching All songs", Toast.LENGTH_SHORT).show();//hindi+english
                setfilter(item.getTitle());
                return true;
            case R.id.item2:
                //English
                Toast.makeText(this,"Fetching English songs", Toast.LENGTH_SHORT).show();//sort the list show only english
                setfilter(item.getTitle());
                return true;
            case R.id.item3:
                //Hindi
                Toast.makeText(this,"Fetching Hindi songs", Toast.LENGTH_SHORT).show();//show only hindi
                setfilter(item.getTitle());
                return true;
            default:
